package com.example.demo2.api.controller.exceptionhandler;
...
public class ControlExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String mensagemDesenvolvedor = messageSource.getMessage("mensagem.notreableDev",null, LocaleContextHolder.getLocale());
